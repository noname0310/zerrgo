...
public class Sprite extends Component implements Renderable, Updatable {
    ...
    @Override
    public void render() {
       scheduler.updateTransform(id, ((Transform)getGameObject().getTransform()).getMatrix());
    }
    ...
    public void start() {
        ...
        if(getGameObject().isPositional()){
            ...
            scheduler.addInstance(id, texture, ((Transform)getGameObject().getTransform()).getMatrix());
